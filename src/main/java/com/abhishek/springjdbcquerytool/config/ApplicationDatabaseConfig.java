package com.abhishek.springjdbcquerytool.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.abhishek.springjdbcquerytool.repository"})
public class ApplicationDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.abhishek.springjdbcquerytool.repository")
